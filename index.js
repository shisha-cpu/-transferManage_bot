...
const scheduleData = {
    'Понедельник': {
        ...
        "Horseka → Ногинск": [
            '08:00 (с заездом в ЧГ)', 
            '18:20 (с заездом в ЧГ)', 
            '21:10 (с заездом в ЧГ, до Дикси, Заречье)', // Добавлена приписка "с заездом в ЧГ"
            '22:35 (с заездом в ЧГ)'  // Изменено с 22:20 на 22:35
        ]
    },
    'Вторник': {
        "Ногинск → Horseka": ['07:00', '09:00'],
    ...
    'Пятница': {
        ...
        "Horseka → Ногинск": [
            '08:00 (с заездом в ЧГ)', 
            '18:20 (с заездом в ЧГ)', 
            '21:10 (с заездом в ЧГ)', // Уже есть приписка
            '22:35 (с заездом в ЧГ)', // Добавлена приписка "с заездом в ЧГ"
            '23:20'
        ]
    },
    'Суббота': {
        ...
        "Horseka → Ногинск": [
            ...
            '18:20 (с заездом в ЧГ)', 
            '21:10 (с заездом в ЧГ)', // Уже есть приписка
            '23:20 (с заездом в ЧГ)'  // Добавлена приписка "с заездом в ЧГ"
        ]
    },
    'Воскресенье': {
        "Ногинск → Horseka": ['07:00', '09:00'],
        ...
        "Horseka → Ногинск": [
            ...
            '18:20 (с заездом в ЧГ)', 
            '21:10 (с заездом в ЧГ, до Дикси, Заречье)', // Добавлена приписка "с заездом в ЧГ"
            '22:35'  // Изменено с 22:20 на 22:35
        ]
    }
};
